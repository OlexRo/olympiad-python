# ===============================================================================
# Одно-связанный список - узел хранит ссылку на следующий узел.
# ===============================================================================
#
#      head                                                     tail
# ┌─────────────┐    ┌─────────────┐    ┌─────────────┐    ┌─────────────┐
...
# │           Node          │
# │  ┌───────────────────┐  │
# │  │   data = значение │  │  ← Данные, которые хранит узел
# │  └───────────────────┘  │
# │  ┌───────────────────┐  │
# │  │   next = ссылка   │  │  ← Указывает на следующий узел (или None)
# │  └───────────────────┘  │
# └─────────────────────────┘
#
# ===============================================================================
...
class SinglyLinkedList:
  def __init__(self):
    self.head = None # Ссылка на первый элемент узла
    self._size = 0   # Размер списка
  ...
  def index(self, value):
    ...
    while current:              # Пока current не None
      ...
      idx += 1                  # Увеличиваем индекс на 1 (теперь idx указывает на следующий элемент)
  ...
  def append(self, data):
    ...
    if self.head is None:             # Проверяемый пустой ли список
      ...
      while current.next is not None: # Идем по цепочке узлом, пока не найдем последний (у последнего next = None)
  ...
  def prepend(self, data):
    ...
    self._size += 1           # Увеличиваем размер списка на 1
  ...
  def insert(self, index, data):
    ...
    if index == 0:                           # Проверяем равен ли индекс 0
  ...
  def pop(self, index = None):
    ...
    current = self.head                       # Начинаем с головы списка, если удаляем не первый
  ...
  # Магический метод для возвращения длины одно-связного списка
  def __len__(self):
    return self._size

  # Магический метод для получения элемента одно-связного списка
  ...
  # Магический метод для итерации по одно-связному списку
  def __iter__(self):
    current = self.head
    while current:
      yield current.data
  ...
  # Магический для возвращения одно-связного списка в строковом представлении
  def __str__(self):
    return f"[{', '.join(str(item) for item in self)}]"

  # Магический для возвращения одно-связного списка в строковом представлении для разработчиков
  def __repr__(self):
    return self.__str__()
